  ...
  const onSubmitHandler = (e) => {
    ...
    for (let user of users) {
      if (user.email === email) {
        ...
        return dispatch(
          setSnackbar(true, "error", "error", "Wprowadź inny adres e-mail")
        );
      }
    }
    ...
    if (
      ...
      dispatch(
        setSnackbar(true, "success", "success", "Zarejestrowano poprawnie!")
      );
  ...
  const onChangeEmailHandler = (e) => {
    ...
    setErrors({
      ...
      emailWrongSyntax:
        ...
        (e.target.value.lastIndexOf(".com") === -1 &&
          e.target.value.lastIndexOf(".pl") === -1),
    });
  };
  ...
  return (
    <div>
      <FormContainer onSubmit={onSubmitHandler}>
        ...
        />
        {errors.firstNameTooShort && (
          <Error>imię musi posiadać co najmniej 3 znaki</Error>
        )}
        <Input
          type="text"
        ...
        />
        {errors.lastNameTooShort && (
          <Error>nazwisko musi posiadać co najmniej 3 znaki</Error>
        )}
        <Input
          type="text"
          placeholder="e-mail"
        ...
        {errors.emailWrongSyntax && (
          <Error>
            email powinien zawierać znak @ i kończyć się znakami .com lub .pl
          </Error>
        )}
        <Input
          type="password"
        ...
        />
        {errors.passwordTooShort && (
          <Error>hasło powinno posiadać co najmniej 6 znaków</Error>
        )}
        {errors.passwordNeedsOneNumber && (
          <Error>hasło powinno zawierać przynajmniej 1 cyfrę</Error>
        )}
